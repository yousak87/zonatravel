...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en"> <!--<![endif]-->
    ...
    <head>
        ...
        <title>Pulau-Bidadari ZONATRAVEL.ASIA HTML5</title> <!--insert your title here-->  
            ...
            <div class="container clearfix">
                <div class="grid_12 green fade-right animate1">
                    ...
                    <div class="contentinfo" style="text-align: justify;text-justify: inter-word;">
                        <p style="font-size: 18px;"><strong>PULAU BIDADARI</strong></p><div style="font-size: 16px;font-family: dream;"><strong>
                                Pulau Bidadari yang memiliki pantai berpasir putih dengan air laut yang jernih kini mempunyai 49 cottage terapung dan berada di darat  merupakan salah satu pulau resort yang paling dekat dengan Jakarta, dimana jarak tempuh dari Jakarta sampai tujuan hanya 20 menit dengan menggunakan speedboat. Dahulu Pengeran Jayakarta dan keluarga kerajaan menjadikannya sebagai tempat rekreasi dan hanya keluarga kerajaan saja yang boleh berekreasi di Pulau ini sehingga disebut Pulau Bidadari. Sebagai salah satu Pulau yang kini memiliki sarana terlengkap, pulau ini merupakan tujuan wisata yang pantas Anda pertimbangkan. </strong></div>
                    </div>
                    <!--end content info-->
                ...
                <div class="grid_6 green fade-left animate1">
                    ...
                    <div class="titlesingleproject">
                        ...
                        <h4 style="font-size: 14px;font-family: dream;font-weight: bold;">PAKET SPEEDBOAT PULAU BIDADARI 2 HARI 1 MALAM</h4>
                    </div>
                    <!--end title and price-->
                ...
                <div class="grid_12 green fade-right animate1">
                    ...
                    <table style="font-size: 16px;font-family: dream;font-weight: bold">
                        <tr ><td width="120px" style="vertical-align: text-top">FASILITAS : </td><td>Restaurant, Land & Floating Cottages, Castle, Billiard, Volley Beach, Play Ground, Karaoke, Meeting Room, Islands Trip, Souvenir Shop, Jet Sky, Bannana Boat.</td></tr>
                    </table><br>
                    <table style="font-size: 16px;font-family: dream;font-weight: bold">
                ...
                <div class="grid_12 green fade-right animate1">
                    ...
                    <table style="width:100%;font-weight: bold;font-family: dream;color: white;font-size: 16px;" >
                        ...
                        <tr>
                            <td>  Family Share 4	</td>
                            <td> Rp.&nbsp;950,000</td>
                            <td>  Rp.1,265,000</td>

                        </tr>
                        <tr>
                            <td> Family Share 2</td>
                            <td>  Rp.1,255,000</td>	
                            <td> Rp1,570,000</td>
                    ...
                    <br>
                    <table style="width:100%;font-weight: bold;font-family: dream;color: white;font-size: 16px;">
                        <tr><td width="150px" style="vertical-align: text-top">PRICE INCLUDE : </td><td>Transportasi Speedboat Marina Ancol - Pulau Bidadari (PP), Asuransi Transportasi Jasa Raharja, Cottages, 3x Makan(1x Sarapan, 1x Makan Siang, 1x Makan Malam),Water Sport, Sepeda, Three Cruise Island, Tax & Services 21%</td></tr>
                    </table>
                    <br><br>
                    ...
                    <table style="font-weight: bold;font-family: dream;color: white;font-size: 16px;">
                        ...
                        <tr>
                            ...
                            <td>:&nbsp;</td>
                            <td>Dari Marina Ancol Dermaga 15</td>
                        </tr>
                        <tr>
