            ...
            <div class="container clearfix">
                ...
                <div class="grid_6 green fade-right animate1">
                    ...
                    <div class="singlepost orange">
                        ...
                        <img alt="" class="imgsinglepost" src="img/kapal/concord.jpg">
                ...
                <div class="grid_6 green fade-right animate1" >
                    ...
                    <h1 class="titlesinglepost" style="font-family: BernardoModaSemibold; color: #ffee00;margin: 0px">CONCORD 1 - 2</h1>
                    <h1>&nbsp;</h1>
                    ...
                    <table>
                        <tr > 
                            ...
                            <td><h1 style="font-size: 24px;color: white;font-family: dream;">Rp.1.890.000</h1></td>
                        </tr>
                        <tr>
                            ...
                            <td><h1 style="font-size: 24px;color: #FFE09C;;font-family: dream;">Rp.3.150.000</h1></td>
                        </tr>
                        <tr>
                            <td><h1 style="font-size: 24px;color: white;font-family: dream;">Pari &nbsp;</h1></td>
                            <td><h1 style="font-size: 24px;color: white;font-family: dream;">:</h1></td>
                            <td><h1 style="font-size: 24px;color: white;font-family: dream;">Rp.4.725.000</h1></td>
                        </tr>
                        <tr>
                            <td><h1 style="font-size: 24px;color: #FFE09C;;font-family: dream;">Tidung / Pramuka &nbsp;</h1></td>
                            <td><h1 style="font-size: 24px;color: #FFE09C;;font-family: dream;">:</h1></td>
                            <td><h1 style="font-size: 24px;color: #FFE09C;;font-family: dream;">Rp.5.250.000</h1></td>
                        </tr>
                        <tr>
                            <td><h1 style="font-size: 24px;color: white;font-family: dream;">Harapan / Kelapa &nbsp;</h1></td>
                            <td><h1 style="font-size: 24px;color: white;font-family: dream;">:</h1></td>
                            <td><h1 style="font-size: 24px;color: white;font-family: dream;">Rp.5.500.000</h1></td>
                        </tr>
                        <tr>
                            <td><h1 style="font-size: 24px;color: #FFE09C;;font-family: dream;">Putri / Sepa</h1></td>
                            <td><h1 style="font-size: 24px;color: #FFE09C;;font-family: dream;">:</h1></td>
                            <td><h1 style="font-size: 24px;color: #FFE09C;;font-family: dream;">Rp.5.670.000</h1></td>
                        </tr>
                        <tr>
                            <td><h1 style="font-size: 24px;color: white;font-family: dream;">Pantara</h1></td>
                            <td><h1 style="font-size: 24px;color: white;font-family: dream;">:</h1></td>
                            <td><h1 style="font-size: 24px;color: white;font-family: dream;">Rp.7.560.000</h1></td>
                        </tr>
                        <tr>
                            <td><h1 style="font-size: 24px;color: #FFE09C;;font-family: dream;">Paket Mancing</h1></td>
                            <td><h1 style="font-size: 24px;color: #FFE09C;;font-family: dream;">:</h1></td>
                            <td><h1 style="font-size: 24px;color: #FFE09C;;font-family: dream;">Rp.8.400.000</h1></td>
                        </tr>
                    </table>
                ...
                <div class="grid_12 green fade-right animate1" >
                    ...
                    <h1 class="titlesinglepost" style="font-size: 24px;font-family: dream;color:white;margin: 0px">Spesifikasi : &nbsp;</b> 18 Penumpang,2x175HP Suzuki - AC, Toilet, Home Theater
                    </h1>
