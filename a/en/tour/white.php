            ...
            <div class="container clearfix">
                ...
                <div class="grid_6 green fade-right animate1">
                    ...
                    <div class="singlepost orange">
                        ...
                        <img alt="" class="imgsinglepost" src="img/kapal/white.jpg">
                ...
                <div class="grid_6 green fade-right animate1" >
                    ...
                    <h1 class="titlesinglepost" style="font-family: BernardoModaSemibold; color: #ffee00;margin: 0px">WHITE DREAM</h1>
                    <h1>&nbsp;</h1>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><h1 style="font-size: 24px;color: #FFE09C;;font-family: dream;">:</h1></td>
                            <td><h1 style="font-size: 24px;color: #FFE09C;;font-family: dream;">Rp.5.040.000</h1></td>
                        </tr>
                        <tr>
                            <td><h1 style="font-size: 24px;color: white;font-family: dream;">Harapan / Kelapa &nbsp;</h1></td>
                            <td><h1 style="font-size: 24px;color: white;font-family: dream;">:</h1></td>
                            <td><h1 style="font-size: 24px;color: white;font-family: dream;">Rp.5.150.000</h1></td>
                        </tr>
                        <tr>
                ...
                <div class="grid_12 green fade-right animate1" >
                    ...
                    <h1 class="titlesinglepost" style="font-size: 24px;font-family: dream;color:white;margin: 0px">Spesifikasi : &nbsp;</b> 8 Penumpang,2x250HP Yamaha
                    </h1>
