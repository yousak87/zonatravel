            ...
            <div class="container clearfix">
                ...
                <div class="grid_12 green fade-right animate1">
                    ...
                    <table style="width:100%;font-weight: bold;font-family: dream;color: white;font-size: 16px;">
                        <tr><td width="150px" style="vertical-align: text-top">PRICE INCLUDE : </td><td>Transportasi Speedboat Marina Ancol - Pulau Kotok(PP), Asuransi Transportasi Jasa Raharja, Welcome Drink, Lunch, Tax & Service 21%</td></tr>
                    </table>
                    <br>
