...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en"> <!--<![endif]-->
    ...
    <head>
        ...
        <title>Pulau-Pelangi ZONATRAVEL.ASIA HTML5</title> <!--insert your title here-->  
            ...
            <div class="container clearfix">
                <div class="grid_12 green fade-right animate1">
                    ...
                    <div class="contentinfo" style="text-align: justify;text-justify: inter-word;">
                        <p style="font-size: 18px;"><strong>PULAU PELANGI</strong></p><div style="font-size: 16px;font-family: dream;"><strong>
                                Pulau Pelangi dengan hiasan warna warni terumbu karang serta keindahan dasar laut dengan ribuan ikan sungguh sangat memanjakan mata para pecintanya, Pulau ini merupakan salah satu resort dengan indahnya alam hutan yang terpelihara dan rimbun bahkan cottage di teduhi rindangnya pepohonan  yang di sajikan untuk Anda. Untuk melengkapi kebahagiaan Anda di sediakan berbagai fasilitas rekreasi yang menarik untuk keluarga atau group.
                            </strong></div>
                    </div>
                    <!--end content info-->
                ...
                <div class="grid_6 green fade-left animate1">
                    ...
                    <div class="titlesingleproject">
                        ...
                        <h4 style="font-size: 14px;font-family: dream;font-weight: bold;">PAKET PULAU PELANGI 2 HARI 1 MALAM</h4>
                    </div>
                    <!--end title and price-->
                ...
                <div class="grid_12 green fade-right animate1">
                    ...
                    <table style="font-size: 16px;font-family: dream;font-weight: bold">
                        <tr ><td width="120px" style="vertical-align: text-top">FASILITAS : </td><td>Restaurant Terapung, Lapangan Tennis, Klinik Kesehatan, Pemandian Air Panas.
                            </td></tr>
                    </table><br>
                    <table style="font-size: 16px;font-family: dream;font-weight: bold">
