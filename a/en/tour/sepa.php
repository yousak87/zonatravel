...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en"> <!--<![endif]-->
    ...
    <head>
        ...
        <title>Pulau-Sepa ZONATRAVEL.ASIA HTML5</title> <!--insert your title here-->  
            ...
            <div class="container clearfix">
                <div class="grid_12 green fade-right animate1">
                    ...
                    <div class="contentinfo" style="text-align: justify;text-justify: inter-word;">
                        <p style="font-size: 18px;"><strong>PULAU SEPA</strong></p><div style="font-size: 16px;font-family: dream;"><strong>
                                Pulau Sepa Resort ini hanya seluas +/- delapan hektar saja yang sebagian dari Pulau telah dibangun fasilitas dan prasarana resort lainnya. Namun tidak bisa di pungkiri pesona Pulau Sepa yang memiliki pantai putih yang membentang luas serta bersih dan suasana tenang ini merupakan salah satu pantai landai  dan indah terbaik yang akan membuat Anda ingin berlama – lama di Pulau Sepa dengan di dukungnya keindahan habitat dasar laut yang akan sungguh memanjakan mata Anda dan mengusir kepenatan akan suasana perkotaan.
                ...
                <div class="grid_6 green fade-left animate1">
                    ...
                    <div class="titlesingleproject">
                        ...
                        <h4 style="font-size: 14px;font-family: dream;font-weight: bold;">PAKET PULAU SEPA 2 HARI 1 MALAM</h4>
                    </div>
                    <!--end title and price-->
                ...
                <div class="grid_12 green fade-right animate1">
                    ...
                    <table style="font-size: 16px;font-family: dream;font-weight: bold">
                        <tr ><td width="120px" style="vertical-align: text-top">FASILITAS : </td><td>Restaurant, Cottages, Meeting Room, Billiard, Bannana Boat, Play Ground, Karaoke, Snorkling, Diving, Fishing, Knee Board, Jet Ski dan Cannoe.
                ...
                <div class="grid_12 green fade-right animate1">
                    ...
                    <br>
                    <table style="width:100%;font-weight: bold;font-family: dream;color: white;font-size: 16px;">
                        <tr><td width="150px" style="vertical-align: text-top">PRICE INCLUDE : </td><td>Speedboat dari Marina Ancol : 08.00 AM, Speedboat dari Pulau Sepa : 02.00 PM, Asuransi Transportasi Jasa raharja, Welcome Drink, 1 X Coffeebreak, 4x Makan (1x Sarapan, 2x Makan Siang, 1x Makan Malam), One Night Accomodation (Check in room : 02.00 PM, Check out room : 12.00 PM), Tax & Service 21%.  
                    ...
                    <table style="font-weight: bold;font-family: dream;color: white;font-size: 16px;">
                        ...
                        <tr>
                            ...
                            <td>:&nbsp;</td>
                            <td>Dari Marina Ancol Dermaga 19</td>
                        </tr>
                        <tr>
