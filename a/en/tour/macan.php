...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en"> <!--<![endif]-->
    ...
    <head>
        ...
        <title>Pulau-Macan ZONATRAVEL.ASIA HTML5</title> <!--insert your title here-->  
            ...
            <div class="container clearfix">
                <div class="grid_12 green fade-right animate1">
                    ...
                    <div class="contentinfo" style="text-align: justify;text-justify: inter-word;">
                        <p style="font-size: 18px;"><strong>PULAU MACAN</strong></p><div style="font-size: 16px;font-family: dream;"><strong>
                                Pulau Macan yang bertema Village dan ECO Resort ini menyajikan surga dunia yang menyatu dengan alam. Popularitas pesona Pulau yang sudah terdengar beberapa tahun ini menyimpan banyak sekali keindahan alam yang pantai dengan pemadangan pasir putih yang membentang luas, serta gradasi warna laut yang sangat memukau sehingga banyak wisatawan local ataupun mancanegara yang ingin berlibur kembali. Jadi, salah satu wisata menakjubkan yang harus anda kunjungi adalah Pulau Macan.
                            </strong></div>
                    </div>
                    <!--end content info-->
                ...
                <div class="grid_6 green fade-right animate1">
                    ...
                    <iframe width="100%" height="390px" src="https://www.youtube.com/embed/ESmAMr-u7U4" frameborder="0" allowfullscreen></iframe>
                </div>
                ...
                <div class="grid_6 green fade-left animate1">
                    ...
                    <div class="titlesingleproject">
                        ...
                        <h4 style="font-size: 14px;font-family: dream;font-weight: bold;">PAKET PULAU MACAN 2 HARI 1 MALAM</h4>
                    </div>
                    <!--end title and price-->
                ...
                <div class="grid_12 green fade-right animate1">
                    ...
                    <table style="font-size: 16px;font-family: dream;font-weight: bold">
                        <tr ><td width="120px" style="vertical-align: text-top">FASILITAS : </td><td>Berbagai aktivitas olahraga air dapat anda nikmati, mulai dari canoe, snorkeling, wind surfing, dan diving.
                            </td></tr>
                    </table><br>
                    <table style="font-size: 16px;font-family: dream;font-weight: bold">
                ...
                <div class="grid_12 green fade-right animate1">
                    ...
                    <table>
                        <tr><td style="background-color: #FFE09C;font-family: BernardoModaSemibold;color: black;font-size: 18px;">ONE DAY TOUR FOR ADULT / CHILD : </td><td style="font-weight: bold;font-family: dream;color: white;font-size: 18px;"> &nbsp; Rp.900.000 / PERSON</td></tr>
                    </table>
                    <table style="width:100%;font-weight: bold;font-family: dream;color: white;font-size: 16px;">
                        <tr><td width="150px" style="vertical-align: text-top">PRICE INCLUDE : </td><td>Transportasi Speedboat Marina Ancol - Pulau Macan (PP),  Asuransi Transportasi Jasa Raharja, Welcome Drink, Makan Siang 1x, Snorkeling, Canoe,  Tax & Service 21%</td></tr>
                    </table>
                    <br>
                    ...
                    <table style="width:100%;font-weight: bold;font-family: dream;color: white;font-size: 16px;" >
                        ...
                        <tr>
                            <td>  Red Brick, Tropical and Eco Island</td>	
                            <td>   Rp 1.725.000</td>	
                            <td>     Rp 1.838.000</td>	
                            <td>    Rp 1.023.000</td>	
                            <td>  Rp 1.139.000</td>	
                    ...
                    <br>
                    <table style="width:100%;font-weight: bold;font-family: dream;color: white;font-size: 16px;">
                        <tr><td width="150px" style="vertical-align: text-top">PRICE INCLUDE : </td><td>Transportasi Speedboat Marina Ancol - Pulau Macan (PP),  Asuransi Transportasi Jasa Raharja, Welcome Drink, Makan 4x, Cottages (Sesuai Pilihan), Canoe, Snorkeling, Tax & Service 21%</td></tr>
                    </table>
                    <br><br>
