...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en"> <!--<![endif]-->
    ...
    <body id="startpage" style="-webkit-box-shadow: inset 0px 0px 400px #000000;box-shadow: inset 0px 0px 400px #000000;">
        ...
        <section id="internalpage">
            ...
            <div class="container clearfix">
                ...
                <div class="grid_4">
                    ...
                    <div id="tag_cloud-4" class="widget widget_tag_cloud" style="background: rgba(5, 6, 6, 0.63)">
                        <h2 style="font-family: dream;background-color: #FFE09C;color: #000;font-weight: bold;"><strong>CONTACT</strong><br><br>
                        ...
                        <br>
                        <img src="../e.jpg" style="float: left;margin-left: 10px;" width="150" height="200"><h3 style="font-family: BernardoModaSemibold; font-weight: bold;font-size: 18px;">&nbsp;EDWARD HAKIM</h3><br>

                        <table style="font-family: dream; font-weight: bold;color: white;font-size: 13px;">
                            <tr>
                                <th align="left">CALL</th>
                                <th>  :</th>
                                <th> 0856 97302 888</th>
                        ...
                        <br><br><br><br><br><br>
                        <img src="../p.jpg" style="float: left;margin-left: 10px;" width="150" height="200"><h3 style="font-family: BernardoModaSemibold; font-weight: bold;font-size: 18px;">&nbsp;PUTRA CUNTORO</h3><br>
                        <table style="font-family: dream; font-weight: bold;color: white;font-size: 13px;">
                            <tr>
                                <th align="left">CALL</th>
                                <th>  :</th>
                        ...
                        <br><br><br><br><br><br>
                        <div style="margin-left: 10px; text-align: left ;font-family: dream;" >
                            We Have Commitment for a Great Holiday & Excellent Services
                            <br> <br>
                ...
                <div class="grid_8">
                    ...
                    <div class="archivesinglepost blue">
                        ...
                        <b style="font-family: BernardoModaSemibold; font-weight: bold;">PEMESANAN :</b><br>

                        <ul style="font-family: dream;"><li>
                                Untuk pemesanan jumlah peserta, lokasi wisata, paket wisata serta waktu yang diinginkan, kami memberi kemudahan bagi Anda untuk menghubungi kami melalui Telepon, BBM, WhatsApp atau dapat langsung Kantor</li>
                            <li>Pembayaran DP dan Pelunasan ditransfer ke rekening bank berikut ini :</li>
                            <br>
                            ...
                            <li>Selain nomor rekening tertera diatas adalah bukan nomor rekening kami.</li>
                            <li>Kami akan mengirimkan email berupa invoice sebagai tanda terima Anda.</li>
                            <li>Peserta langsung berangkat pada hari yang telah ditentukan.</li>
                        </ul>
                        <br><br>
                        <b style="font-family: BernardoModaSemibold; font-weight: bold;">SYARAT DAN KETENTUAN :</b><br>
                        <ul style="font-family: dream;">
                            <li>Pendaftaran jumlah peserta paling lambat 10 hari sebelum keberangkatan.</li>
                            <li>Peserta dengan umur di atas 2 tahun dikenakan biaya penuh.</li>
                            <li>Pembayaran uang muka (DP) sebesar 30% dari harga paket dan pelunasan dilakukan paling lama 5 hari sebelum hari keberangkatan.</li>
                            <li>Apabila terjadi pembatalan dari pihak Anda, maka uang yang sudah dibayar akan kami nyatakan hangus.</li>
                            <li> Jika terjadi pengurangan peserta 1 minggu sebelum keberangkatan, harga paket tetap dihitung sesuai jumlah peserta awal yang telah didaftarkan.</li>
                            <li>  Kehilangan/Kerusakan barang sepenuhnya ditanggung peserta travel.</li>
                            <li>Kapal siang dari Pulau hanya ada di hari Minggu dan Jumat (Kecuali High Season).</li>
                            <li> Kegiatan di sesuaikan dengan waktu dan dapat berubah sewaktu-waktu karena cuaca.</li>

                            <li>  Libur Tahun Baru & Lebaran Idul Fitri harga paket naik 10%. </li>
                        </ul>
                        <br><br>
                        <b style="font-family: BernardoModaSemibold; font-weight: bold;">PERLENGKAPAN YANG HARUS DISIAPKAN :</b>
                        <ul style="font-family: dream;">
                            <li>Pakaian secukupnya serta kacamata gelap.</li>
                            <li>Obat-obatan pribadi & perlengkapan mandi.</li>
                            <li>Uang secukupnya, karena di tempat wisata tidak terdapat ATM. </li>
                            <li>Pakaian renang/ dry suit untuk snorkeling dan bermain di pantai.</li>
    ...
    <!-- Mirrored from www.nicdarkthemes.com/themes/love-travel/html/demo/blog-standard-left-sidebar.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Nov 2015 17:47:39 GMT -->
</html>